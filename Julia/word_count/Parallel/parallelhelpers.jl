...
@everywhere function countwords(text)
    textSep = split(text," ")
...
# getnormcount takes the a dictionary of counts and overall counts and calculates the normalized count
@everywhere function getnormcount(counts,globalcounts)
...
@everywhere function getnormcount(counts)
